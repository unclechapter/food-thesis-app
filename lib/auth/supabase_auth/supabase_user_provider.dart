...
class FoodScanAppSupabaseUser extends BaseAuthUser {
  FoodScanAppSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> foodScanAppSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FoodScanAppSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
